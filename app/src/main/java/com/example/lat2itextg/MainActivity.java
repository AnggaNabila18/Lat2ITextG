package com.example.lat2itextg;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCreateButton = (Button) findViewById(R.id.button_crate);
        mCreateButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (mContentEditText.getText().toString().isEmpty()) {
                    mContentEditText.setError("Tidak Boleh Kosong!!!");
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResult) {
        switch (requestCode) {
            ...
            default: super.onRequestPermissionsResult(requestCode, permissions, grantResult);
            }
        }
